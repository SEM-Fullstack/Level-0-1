...
export default function AddPage() {
    ...
    return (
        <div className="flex flex-col items-center h-screen w-full mx-auto">
            ...
            <div className="w-1/2">
                <Form {...form}>
                    <FormItem className="mb-4">
                        ...
                        <FormControl>
                            <Select onValueChange={onSelectMood} defaultValue={form.watch('mood')}>
                                <FormItem>
                                    <FormControl>
                                        <SelectTrigger>
                                ...
                                <SelectContent>
                                    {moods.map(mood => (
                                        <SelectItem
                                            key={mood}
                                            value={mood}
                                        >{`${mood} ${MoodEmoji[mood]}`}</SelectItem>
                                    ))}
                                </SelectContent>
                            </Select>
                        </FormControl>
